import argparse
from process_bands import epoching, save_prepr,mvnn
...
parser.add_argument('--sfreq', default=250, type=int) # change resampling freq. through command line
parser.add_argument('--mvnn_dim', default='time', type=str)
parser.add_argument('--project_dir', default='../project_directory', type=str)
#parser.add_argument('--band', default='beta', type=str, choices=['delta', 'theta', 'alpha', 'beta', 'gamma'],
