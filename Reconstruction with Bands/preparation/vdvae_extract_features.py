...
image_path = '/home/tanaya/.virtualenvs/EEG-Image-Reconstruction-main/data/thingseeg2_metadata/train_images.npy'
train_images = batch_generator_external_images(data_path = image_path)

image_path = '/home/tanaya/.virtualenvs/EEG-Image-Reconstruction-main/data/thingseeg2_metadata/test_images.npy'
...
train_latents = []
for i,x in tqdm(enumerate(trainloader), total=len(trainloader), desc='Extracting train VDVAE latents'):
  data_input, target = preprocess_fn(x)
  with torch.no_grad():
        # print(i*batch_size)
        activations = ema_vae.encoder.forward(data_input)
