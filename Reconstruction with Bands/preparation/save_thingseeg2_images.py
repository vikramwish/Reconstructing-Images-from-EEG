...
img_metadata = np.load('/home/tanaya/.virtualenvs/EEG-Image-Reconstruction-main/data/thingseeg2_metadata/image_metadata.npy',allow_pickle=True).item()
...
for train_img_idx in tqdm(range(n_train_img), total=n_train_img, desc='Loading train images'):
    train_img_dir = os.path.join('/home/tanaya/.virtualenvs/EEG-Image-Reconstruction-main/data/thingseeg2_metadata/', 'training_images',
...
np.save('/home/tanaya/.virtualenvs/EEG-Image-Reconstruction-main/data/thingseeg2_metadata/train_images.npy', train_img)

for test_img_idx in tqdm(range(n_test_img), total=n_test_img, desc='Loading test images'):
    test_img_dir = os.path.join('/home/tanaya/.virtualenvs/EEG-Image-Reconstruction-main/data/thingseeg2_metadata/', 'test_images',
...
np.save('/home/tanaya/.virtualenvs/EEG-Image-Reconstruction-main/data/thingseeg2_metadata/test_images.npy', test_img)

test_images_dir = '/home/tanaya/.virtualenvs/EEG-Image-Reconstruction-main/data/thingseeg2_metadata/test_images_direct/'
