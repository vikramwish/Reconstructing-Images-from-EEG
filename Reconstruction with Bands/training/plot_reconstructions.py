...
recon_dir = f'/mnt/data12_16T/tanaya/data/eeg_dataset/results_17/thingseeg2_preproc/sub-{sub:02d}/'
image_ids = list(range(200))
if ordered_by_performance:


    feats_dir = f'/mnt/data12_16T/tanaya/data/eeg_dataset/results_17/thingseeg2_preproc/eval_features/sub-{sub:02d}/versatile_diffusion{param}'
    test_feats_dir = '/mnt/data12_16T/tanaya/results/thingseeg2_test_images_eval_features'
...
def load_test_image(image_id):
    return mpimg.imread(f'/mnt/data12_16T/tanaya/data/thingseeg2_metadata/test_images_direct/{image_id}.png')
