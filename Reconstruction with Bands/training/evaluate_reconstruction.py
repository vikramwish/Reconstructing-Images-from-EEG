...
images_dir = f'/mnt/data12_16T/tanaya/data/eeg_dataset/results_hgmm/thingseeg2_preproc/sub-{sub:02d}/versatile_diffusion{param}'
feats_dir = f'/mnt/data12_16T/tanaya/data/eeg_dataset/results_hgmm/thingseeg2_preproc/eval_features/sub-{sub:02d}/versatile_diffusion{param}/'



if not using_cliptext and not using_clipvision:
    images_dir = f'/mnt/data12_16T/tanaya/data/eeg_dataset/results_hgmm/thingseeg2_preproc/sub-{sub:02d}/vdvae'
    feats_dir = f'/mnt/data12_16T/tanaya/data/eeg_dataset/results_hgmm/thingseeg2_preproc/eval_features/sub-{sub:02d}/vdvae/'
...
feats_dir = f'/mnt/data12_16T/tanaya/data/eeg_dataset/results_hgmm/thingseeg2_preproc/eval_features/sub-{sub:02d}/versatile_diffusion{param}'
gen_image_dir = f'/mnt/data12_16T/tanaya/data/eeg_dataset/results_hgmm/thingseeg2_preproc/sub-{sub:02d}/versatile_diffusion{param}/'
performances_save_dir = f'/mnt/data12_16T/tanaya/data/eeg_dataset/results_hgmm/thingseeg2_preproc/sub-{sub:02d}/performances_versatile_diffusion{param}.npy'


if not using_cliptext and not using_clipvision:
    feats_dir = f'/mnt/data12_16T/tanaya/data/eeg_dataset/results_hgmm/thingseeg2_preproc/eval_features/sub-{sub:02d}/vdvae'
    gen_image_dir = f'/mnt/data12_16T/tanaya/data/eeg_dataset/results_hgmm/thingseeg2_preproc/sub-{sub:02d}/vdvae/'
    performances_save_dir = f'/mnt/data12_16T/tanaya/data/eeg_dataset/results_hgmm/thingseeg2_preproc/sub-{sub:02d}/performances_vdvae.npy'
...
for i in range(200):
    gt_image = Image.open('/mnt/data12_16T/tanaya/data/thingseeg2_metadata/test_images_direct/{}.png'.format(i)).resize((512,512)) # either both 512 or both 500
...
print("PixCorr for each image: {}".format(pixcorr_list))
print('SSIM fro each image: {}'.format(ssim_list))
