...
# Specify the folder
folder = '/mnt/data12_16T/tanaya/data/eeg_dataset/results_17/thingseeg2_preproc/sub-08/versatile_diffusion'
...
pred_clip = np.load('/mnt/data12_16T/tanaya/data/eeg_dataset/results_17/thingseeg2_preproc/eval_features/sub-08/versatile_diffusion/clip_final.npy')
...
plt.savefig('/mnt/data12_16T/tanaya/data/eeg_dataset/results_17/thingseeg2_preproc/sub-08/umap_CLIP.png',bbox_inches='tight')